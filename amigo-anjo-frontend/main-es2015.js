...
let AppComponent = class AppComponent {
    ...
    getSidenavState() {
        return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.getState = yield this.sidenav$
                .getState()
                .subscribe((resp) => {
...
let AppModule = AppModule_1 = class AppModule extends _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["HammerGestureConfig"] {
    constructor() {
        super(...arguments);
        this.overrides = {
...
const itemStateTrigger = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('itemState', [
...
const slideStateTrigger = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('slideState', [
...
let SidenavComponent = class SidenavComponent {
    ...
    getSidenavState() {
        return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.getState = yield this.sidenav$.getState()
                .subscribe((resp) => {
                this.sidenavState = resp;
                resolve();
            }),
...
const { protocol, domain } = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api;
...
let SidenavService = class SidenavService {
    ...
    setInitialState(state) {
        return new Promise((resolve) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.getSideNavStatus.next(state);
            resolve();
        }));
    }
    toggleSideNav() {
