...
var UserCardComponent = /** @class */ (function () {
    ...
    UserCardComponent.prototype.enterEdtionMode = function () {
        var _this = this;
    ...
    UserCardComponent.prototype.handleDelete = function (user) {
        this.deleteUser.emit(user);
    };
    UserCardComponent.prototype.handleEdition = function (user) {
...
var UsersAdmComponent = /** @class */ (function () {
    function UsersAdmComponent(usersService) {
        this.usersService = usersService;
    }
    UsersAdmComponent.prototype.ngOnInit = function () {
        this.getAllUsers();
    };
    UsersAdmComponent.prototype.getAllUsers = function () {
        this.usersList$ = this.usersService.getAllUsers();
    };
    UsersAdmComponent.prototype.trackByUsers = function (index, item) {
        return item.id;
    };
    UsersAdmComponent.prototype.handleDeleterUser = function (user) {
        console.log('delete user', user);
    };
    UsersAdmComponent.prototype.handleEditUser = function (user) {
